...
[![dotenvx](https://dotenvx.com/dotenv-banner.png)](https://dotenvx.com/?utm_source=github\&utm_medium=readme\&utm_campaign=motdotla-dotenv\&utm_content=banner)
...
<img src="https://raw.githubusercontent.com/motdotla/dotenv/master/dotenv.svg" alt="dotenv" width="200">
...
Importa con [ES6](README-es.md#como-uso-dotenv-con-import):
...
<summary>Valores Multilínea</summary>
...
<summary>Expansión de Variables</summary>
...
<summary>Sustitución de Comandos</summary>
...
<summary>Múltiples Entornos</summary>
...
<summary>¿Debo hacer commit de mi archivo `.env`?</summary>
...
<summary>¿Qué pasa con la expansión de variables?</summary>
...
<summary>¿Debo tener múltiples archivos `.env`?</summary>
...
<summary>¿Cómo uso dotenv con `import`?</summary>
...
<summary>¿Puedo personalizar/escribir plugins para dotenv?</summary>
...
<summary>¿Qué reglas sigue el motor de análisis?</summary>
...
<summary>¿Qué hay de sincronizar y proteger archivos .env?</summary>
...
<summary>¿Qué pasa si hago commit accidentalmente de mi archivo `.env`?</summary>
...
<summary>¿Qué pasa con variables de entorno que ya estaban definidas?</summary>
...
<summary>¿Cómo evito incluir mi archivo `.env` en un build de Docker?</summary>
...
<summary>¿Por qué no aparecen mis variables de entorno en React?</summary>
...
<summary>¿Por qué el archivo `.env` no carga mis variables de entorno correctamente?</summary>
...
<summary>¿Por qué recibo el error `Module not found: Error: Can't resolve 'crypto|os|path'`?</summary>
...
`config` leerá tu archivo `.env`, analizará su contenido, lo asignará a [`process.env`](https://nodejs.org/docs/latest/api/process.html#process_process_env), y devolverá un objeto con una clave `parsed` con el contenido cargado o una clave `error` si falla.
