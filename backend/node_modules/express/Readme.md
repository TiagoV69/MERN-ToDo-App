...
**This project has a** [**Code of Conduct**](https://github.com/expressjs/.github/blob/HEAD/CODE_OF_CONDUCT.md)**.**
...
[![NPM Version](https://img.shields.io/npm/v/express)](https://npmjs.org/package/express) [![NPM Downloads](https://img.shields.io/npm/dm/express)](https://npmcharts.com/compare/express?minimal=true) [![Linux Build](https://img.shields.io/github/actions/workflow/status/expressjs/express/ci.yml?branch=master\&label=ci)](https://github.com/expressjs/express/actions/workflows/ci.yml) [![Test Coverage](https://img.shields.io/coverallsCoverage/github/expressjs/express?branch=master)](https://coveralls.io/r/expressjs/express?branch=master) [![OpenSSF Scorecard Badge](https://api.scorecard.dev/projects/github.com/expressjs/express/badge)](https://ossf.github.io/scorecard-visualizer/#/projects/github.com/expressjs/express)
